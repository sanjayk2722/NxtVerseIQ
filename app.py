    ...
    def render_about(self):
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name"Sanjay K (Sanjee ❤)</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/sanjayk2722" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/sanjay2722/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:sanjay272209@gmail.com" class="social-link" target="_blank">
